directory_path = 'D:/Tesis/data_test/Formato-2'
...
weekly_facts_string = 'A, C:D, F, W, Y'

daily_facts_names = ['Fecha diaria', 'T° min', 'T° MAX', 'O2 min', 'O2 MAX']
daily_facts_string =  'AA, DS, DT, DW, DX' # AB daily date, FA T° min, FB T° MAX, FE O2 min, FF O2 MAX